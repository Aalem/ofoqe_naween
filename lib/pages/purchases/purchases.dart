...
import 'package:ofoqe_naween/pages/purchases/pages/add_invoice.dart';
import 'package:ofoqe_naween/pages/money_exchange/pages/add_transaction.dart';
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                if (_showFilters && pagesize.getWidth(context) >= 1200)
